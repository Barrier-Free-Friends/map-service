package org.bf.mapservice.mapservice.infrastructure.config;
...
@Configuration
public class MapSwaggerConfig {


    private final String PREFIX = "/v1/map";
    ...
    public OpenAPI openAPI(@Value("${openapi.service.url}") String url) {
        return new OpenAPI()
                ...
                .info(new Info().title("Barrier-Free-Friends MAP Service").version("1.0")
                        .description("MAP API"));
    }
